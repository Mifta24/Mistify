                ...
                <div class="position-relative mb-4">
                    ...
                    @auth
                        <form action="{{ route('wishlist.toggle', $product) }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-light rounded-circle position-absolute top-0 end-0 m-3 shadow-sm">
                ...
                <div class="ps-lg-4">
                    ...
                    <form id="addToCartForm">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="size-options d-flex flex-wrap gap-2">
                                @foreach($product->sizes as $size => $sizeData)
                                    @php
                                        $sizePrice = is_array($sizeData) ? ($sizeData['price'] ?? $product->price) : $sizeData;
                                        $sizeStock = is_array($sizeData) ? ($sizeData['stock'] ?? 0) : 0;
                                    @endphp
                                    <div class="form-check form-option">
                                        <input class="form-check-input"
                                               ...
                                               {{ $product->default_size == $size ? 'checked' : '' }}
                            ...
                            <input type="hidden" name="selected_size" id="selected-size" value="{{ $product->default_size }}">
                        </div>
                        @endif
                        ...
                        <div class="d-flex gap-2 mb-4">
                            <button type="button" id="add-to-cart-btn" class="btn btn-primary flex-grow-1 py-2" data-product-id="{{ $product->id }}">
